...
Traveling Salesman problem takes in a a text file as a input and determines shortest
path while calculating the cost of the trip based of the weighted path.
